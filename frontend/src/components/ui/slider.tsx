  ...
  const renderThumb = (value: number) => {
    const thumb = (
      <SliderPrimitive.Thumb
        ...
        className="block size-4 shrink-0 rounded-full bg-background shadow-sm ring-ring/50 transition-[color,box-shadow] outline-none hover:ring-4 focus-visible:ring-4"
